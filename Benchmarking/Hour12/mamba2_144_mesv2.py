...
def TFT_train(train_df, param):
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath="checkpoints/",
        filename="mamba144_MES-{epoch:02d}-{val_loss:.2f}",
        save_top_k=3,
        monitor="val_loss",
        mode="min",
        save_last=True,
    ...
    first_epoch_timer = FirstEpochTimer(
        ...
        gcs_prefix="checkpoints_mamba144_MESv2"
    )
    # --- GCS checkpoint uploader callback ---
    gcs_ckpt_prefix = "checkpoints_mamba144_MESv2"
...
if __name__ == "__main__":
    ...
    # Save model to GCS
    save_tft_to_gcs(tft, model_name="Mamba2_12h_144c_MESv2")