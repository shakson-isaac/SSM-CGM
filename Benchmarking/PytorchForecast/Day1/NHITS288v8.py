...
def Nhits_train(train_df, param):
    ...
    nhits = NHiTS.from_dataset(
            ...
            static_hidden_size=16,
            shared_weights=True,
            dropout=0.15,             # a bit more regularization
            backcast_loss_ratio=0.25,  # help generalization
            loss=MAE(),
            learning_rate=8e-5,       # slightly lower to offset width
            log_interval=50,
            reduce_on_plateau_patience=4,
    )
    ...
    first_epoch_timer = FirstEpochTimer("first_epoch_runtime.txt", _BUCKET_NAME, "checkpoints_nhits_288v8")
    gcs_ckpt_prefix = "checkpoints_nhits_288v8"
...
if __name__ == "__main__":
    ...
    save_model_to_gcs(nhits, model_name="NHiTS_12h_288cv8")