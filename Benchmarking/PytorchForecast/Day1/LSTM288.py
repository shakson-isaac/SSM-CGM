...
GCS_CHECKPOINT_PREFIX = "checkpoints_lstm_baseline288"
...
PARAM = {"dataset": {"context_length": 288, "horizon": 12, "batch_size": 32}}
...
if __name__ == "__main__":
    ...
    save_lstm_to_gcs(model, training_ds, model_name="LSTM_12h_288c_baseline")
