...
def Nhits_train(train_df, param):
    ...
    nhits = NHiTS.from_dataset(
        ...
        hidden_size = 128,
        n_layers = 2,
        n_blocks = [2,2,2],       # 3 stacks, 2 blocks each
        pooling_sizes = [2,4,8],  # multi-scale
    ...
    first_epoch_timer = FirstEpochTimer("first_epoch_runtime.txt", _BUCKET_NAME, "checkpoints_nhits_288v6")
    gcs_ckpt_prefix = "checkpoints_nhits_288v6"
...
if __name__ == "__main__":
    ...
    save_model_to_gcs(nhits, model_name="NHiTS_12h_288cv6")