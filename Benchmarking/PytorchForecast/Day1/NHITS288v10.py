...
def Nhits_train(train_df, param):
    ...
    nhits = NHiTS.from_dataset(
        ...
        hidden_size=48,
        n_layers=1,
        n_blocks=[1, 1],          # two shallow stacks
        pooling_sizes=[2, 2],     # both at ×2 to retain peaks
        static_hidden_size=12,
        shared_weights=True,
        dropout=0.1,
        backcast_loss_ratio=0.2,  # slightly stronger than #1
        loss=MAE(),
        learning_rate=1e-4,
        log_interval=50,
    ...
    first_epoch_timer = FirstEpochTimer("first_epoch_runtime.txt", _BUCKET_NAME, "checkpoints_nhits_288v10")
    gcs_ckpt_prefix = "checkpoints_nhits_288v10"
...
if __name__ == "__main__":
    ...
    save_model_to_gcs(nhits, model_name="NHiTS_12h_288cv10")