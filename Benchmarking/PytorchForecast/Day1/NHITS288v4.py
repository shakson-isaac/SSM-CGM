...
def Nhits_train(train_df, param):
    ...
    first_epoch_timer = FirstEpochTimer("first_epoch_runtime.txt", _BUCKET_NAME, "checkpoints_nhits_288v4")
    gcs_ckpt_prefix = "checkpoints_nhits_288v4"
...
if __name__ == "__main__":
    ...
    save_model_to_gcs(nhits, model_name="NHiTS_12h_288cv4")