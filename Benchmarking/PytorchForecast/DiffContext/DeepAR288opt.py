...
GCS_CKPT_PREFIX = "checkpoints_deepar288opt"
...
def main():
    ...
    parser.add_argument("--model-name", default="DeepAR_12h_288cOPT", help="Model name for GCS artifacts")
