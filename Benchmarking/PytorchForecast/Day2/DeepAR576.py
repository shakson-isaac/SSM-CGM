...
GCS_CKPT_PREFIX = "checkpoints_deepar576"
...
def main():
    ...
    parser.add_argument("--model-name", default="DeepAR_12h_576c", help="Model name for GCS artifacts")
    ...
    # Choose preset
    preset = param_deepar_48 #param_deepar_24 if args.preset == "24" else param_deepar_48
