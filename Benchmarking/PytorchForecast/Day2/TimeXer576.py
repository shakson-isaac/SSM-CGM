...
timexer_param = timexer_param_48
...
def TimeXer_train(train_df: pd.DataFrame, param: dict):
    ...
    ckpt_prefix = "checkpoints_timexer576"

    checkpoint_cb = ModelCheckpoint(
        dirpath="checkpoints/",
        filename="timexer576-{epoch:02d}-{val_loss:.2f}",
        save_top_k=3,
        monitor="val_loss",
        mode="min",
        save_last=True,
...
def save_timexer_to_gcs(
    model: _TimeXer,
    model_name: str = "TimeXer_12h_576c",
...
if __name__ == "__main__":
    ...
    save_timexer_to_gcs(timexer, model_name="TimeXer_12h_576c")
