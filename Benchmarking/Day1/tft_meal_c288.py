...
def TFT_train(train_df):
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath="checkpoints/",
        filename="tft288-{epoch:02d}-{val_loss:.2f}",
        save_top_k=3,
        monitor="val_loss",
        mode="min",
        save_last=True,
    ...
    first_epoch_timer = FirstEpochTimer(
        ...
        gcs_prefix="checkpoints_tft_288v3"
    )
    # --- GCS checkpoint uploader callback ---
    gcs_ckpt_prefix = "checkpoints_tft_288v3"
...
if __name__ == "__main__":
    ...
    # Save model to GCS
    save_tft_to_gcs(tft, model_name="TFT_12h_288cv3")